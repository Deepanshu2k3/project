    ...
    <>
      <header>
        <div className='container'>
          <div className='logo'>
            <Link href='/'>
              <TitleLogo title='ViralWeb3' className='logomin' />
            </Link>
          </div>
          <nav className={open ? "openMenu" : "closeMenu"} onClick={() => setOpen(null)}>
           ...
           <a target="_blank" href="https://calendly.com/viralweb3"><button className='button-primary'>book a consultation</button></a> 
          </nav>
